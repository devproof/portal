...
public class BlogPanelTest {
    ...
    public void testRenderDefaultPanel() {
        tester.startPanel(createBlogPanel());
        tester.assertComponent("panel", BlogPanel.class);
    }

    private TestPanelSource createBlogPanel() {
        return new TestPanelSource() {
            ...
            public Panel getTestPanel(String panelId) {
                ...
                return new BlogPanel(panelId, Model.of(blog));
            }
        };
    }
}
