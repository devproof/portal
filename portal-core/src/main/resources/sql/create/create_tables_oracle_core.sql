...
CREATE TABLE "DEVPROOF"."ARTICLE_TAG"
...
CREATE TABLE "DEVPROOF"."ARTICLE_TAG_XREF"
 (	"ARTICLE_ID" NUMBER(10,0) NOT NULL ENABLE,
  "TAGNAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
   CONSTRAINT "FKAB3F87C987D7E7EA" FOREIGN KEY ("TAGNAME")
    REFERENCES "DEVPROOF"."ARTICLE_TAG" ("TAGNAME") ENABLE
 ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
TABLESPACE "USERS" ;
...
CREATE TABLE "DEVPROOF"."BLOG_TAG"
 (	"TAGNAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."BOOKMARK"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."BOOKMARK_TAG"
 (	"TAGNAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."COMMENTS"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."CORE_BOX"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."CORE_CONFIGURATION"
...
CREATE TABLE "DEVPROOF"."CORE_EMAIL_TPL"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."CORE_MODULE_LINK"
...
CREATE TABLE "DEVPROOF"."CORE_RIGHT"
 (	"RIGHT_ID" VARCHAR2(50 CHAR) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."CORE_ROLE"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."CORE_USER"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "ACTIVE" NUMBER(1,0) NOT NULL ENABLE,
...
CREATE UNIQUE INDEX "DEVPROOF"."SYS_C005178" ON "DEVPROOF"."CORE_USER" ("ID")
PCTFREE 10 INITRANS 2 MAXTRANS 255
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
TABLESPACE "USERS" ;

CREATE UNIQUE INDEX "DEVPROOF"."SYS_C005179" ON "DEVPROOF"."CORE_USER" ("USERNAME")
PCTFREE 10 INITRANS 2 MAXTRANS 255
STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
TABLESPACE "USERS" ;
...
CREATE TABLE "DEVPROOF"."DOWNLOAD"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."DOWNLOAD_TAG"
 (	"TAGNAME" VARCHAR2(255 CHAR) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
...
CREATE TABLE "DEVPROOF"."OTHER_PAGE"
 (	"ID" NUMBER(10,0) NOT NULL ENABLE,
  "CREATED_AT" TIMESTAMP (6),
  "CREATED_BY" VARCHAR2(30 CHAR),
  "MODIFIED_AT" TIMESTAMP (6),
