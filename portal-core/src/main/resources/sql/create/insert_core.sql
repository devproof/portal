...
INSERT INTO core_configuration (conf_key,conf_description,conf_group,conf_type,conf_value) VALUES ('spring.emailTemplateRepository.findAll.subject.id.forgotemail','Forgot your password email','Email','java.lang.Integer','2');
