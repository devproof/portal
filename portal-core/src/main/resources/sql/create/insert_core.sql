...
INSERT INTO core_right (right_id,description,created_at,created_by,modified_at,modified_by) VALUES ('page.ContactPage','Contact Form: User which are allowed to access the contact form',{ts '2009-01-05 23:01:39.000'},'admin',{ts '2009-01-06 15:59:04.000'},'admin');
...
<!-- AddThis Button END -->
<br/>',1,'AddThis.com',1);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 11:41:22.000'},'admin',{ts '2009-01-05 13:22:25.000'},'admin','TagCloudBoxPanel',null,7,'Related Tags Box',0);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 11:43:49.000'},'admin',{ts '2009-01-05 13:22:25.000'},'admin','SearchBoxPanel',null,2,'Search Box',0);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 12:16:28.000'},'admin',{ts '2009-01-05 13:22:03.000'},'admin','LoginBoxPanel',null,6,'Login Box',0);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 12:16:38.000'},'admin',{ts '2009-01-05 13:22:03.000'},'admin','UserBoxPanel',null,3,'User Box',0);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 12:17:03.000'},'admin',{ts '2009-01-05 15:36:40.000'},'admin','PageAdminBoxPanel',null,4,'Page Administration Box',0);
INSERT INTO core_box (created_at,created_by,modified_at,modified_by,box_type,content,sort,title,hide_title) VALUES ({ts '2009-01-05 12:17:35.000'},'admin',{ts '2009-01-05 13:11:05.000'},'admin','GlobalAdminBoxPanel',null,5,'Global Administration Box',0);
