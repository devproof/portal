...
public class KittenCaptchaPanel extends Panel {
     ...
     * @param imageSize Size of kitten captcha image
     */
...
//                 Map<String, String[]> parameters = request.getParameterMap();
     ...
     * @param newAnimal New animal to place
    ...
    /**
     * @param max Maximum size of random value
    ...
    private static class Animal {
         ...
         * @param isKitten True if the animal is a kitten
         */
        ...
        private BufferedImage load(final String filename) {
            try {
                final BufferedImage loadedImage = ImageIO.read(new MemoryCacheImageInputStream(KittenCaptchaPanel.class.getResourceAsStream(filename + ".png")));
                final BufferedImage image = new BufferedImage(loadedImage.getWidth(), loadedImage.getHeight(), BufferedImage.TYPE_INT_ARGB);
    ...
    private class CaptchaImageResource extends DynamicImageResource {
        ...
        /**
         * @param animals The positioned animals
         */
...
//            invalidate(); // TODO
    ...
    private class PlacedAnimalList implements Serializable {
        ...
        /**
         * @param location The cursor location that was clicked
