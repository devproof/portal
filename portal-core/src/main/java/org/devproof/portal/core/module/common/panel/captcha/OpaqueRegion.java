 ...
 * simple rectangle list enclosing all opaque pixels. The list is used by
 * {@link #contains(Point)} to do hit testing. An effective z-ordering of hit
 * test regions is enabled by {@link #subtract(OpaqueRegion, Point)}.
 *
...
class OpaqueRegion {
     ...
     * @throws IllegalArgumentException Thrown if image is not TYPE_INT_ARGB
     */
    ...
    /**
     * @param rectangles List of rectangles in opaque area
     */
    ...
    /**
     * @param removeRegion The region to subtract from this one
     * @param offset       An offset to apply to the remove region
