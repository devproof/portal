 ...
 * @author Carsten Hufe (modified)
 * @param <T>
 *            type of model object
 * 
 */
public abstract class StatelessAjaxLink<T> extends AbstractLink implements IAjaxLink {
	...
	public StatelessAjaxLink(final String id, final IModel<T> model) {
		...
		add(new AjaxEventBehavior("onclick") {
			...
			protected IAjaxCallDecorator getAjaxCallDecorator() {
				return new CancelEventIfNoAjaxDecorator(StatelessAjaxLink.this.getAjaxCallDecorator());
			}
