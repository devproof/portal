...
public abstract class DeadlinkCheckPanel<T extends BaseLinkEntity> extends Panel {
    ...
    private ProgressionModel createProgressionModel() {
        return new ProgressionModel() {
            ...
            protected Progression getProgression() {
                String descr = new StringResourceModel(section + "Progress", DeadlinkCheckPanel.this, null, new Object[]{DeadlinkCheckPanel.this.actualItem, DeadlinkCheckPanel.this.maxItem}).getString();
     ...
     *
     * @param brokenEntity broken entity
     */
     ...
     *
     * @param validEntity valid entity
     */
