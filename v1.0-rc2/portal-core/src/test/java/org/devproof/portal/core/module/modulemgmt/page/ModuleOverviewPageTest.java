 ...
 * @author Carsten Hufe
 */
public class ModuleOverviewPageTest extends TestCase {
	...
	public void testRenderDefaultPage() {
		this.tester.startPage(ModuleOverviewPage.class);
		this.tester.assertRenderedPage(ModuleOverviewPage.class);
	}
}
