 ...
 * @author Carsten Hufe
 */
public class EmailTemplatePageTest extends TestCase {
	...
	public void testRenderDefaultPage() {
		this.tester.startPage(EmailTemplatePage.class);
		this.tester.assertRenderedPage(EmailTemplatePage.class);
	}
}
