INSERT INTO other_page (created_at,created_by,modified_at,modified_by,content,content_id) VALUES ({ts '2009-01-06 19:40:23.000'},'admin',{ts '2009-01-06 19:40:23.000'},'admin','<p>Terms of use for registration.</p>','terms_of_use');
